...
image:https://github.com/aetos382/ComparisonGenerator/workflows/dotnet.yml/badge.svg[GitHub Workflow Status,link=https://github.com/aetos382/ComparisonGenerator/actions/workflows/dotnet.yml]
